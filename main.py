...
if not ('file' in st.session_state and 'type' in st.session_state):
    ...
    display_instructions(expanded=False)
...
therefore they can be inaccurate.
                    <br>
                    Double verify important information.
                </span>
            </div>""")
...
provided, reply with a very short response(in 10 words) something like 'your question is out of scope.'
"""
        ...
        if 'messages' not in st.session_state:
            st.session_state.messages = [
                {
                    "role": "assistant",
                    "content": "Hello! I am Al your AI assistant for media analysis."
                }
            ]
